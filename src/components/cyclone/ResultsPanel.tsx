...
import { CostReportSection, SensitivitySection } from "@/components/cyclone/CostSensitivityPanels";
...
export function ResultsPanel() {
  ...
  // Include cycle 0 so the X-axis starts at 0.
        ...
        <Tabs defaultValue="element">
          <TabsList className="flex h-auto w-full flex-wrap">
            ...
            {sensitivityResult && sensitivityResult.rows.length > 0 && (
              <TabsTrigger value="sensitivity" className="flex-1 text-xs">
                Sensitivity
              </TabsTrigger>
            )}
          </TabsList>
