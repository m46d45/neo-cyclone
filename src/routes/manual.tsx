...
Durations: …
          ...
          <h3 className="font-display mt-6 text-base font-semibold text-foreground">2.7 Quick path</h3>
          <p className="mt-3 text-[13px] leading-relaxed text-foreground/90">Example or Format Prompt → <strong className="text-foreground">Draw Model</strong> → check diagram (Ch.4) → cycles & seed → <strong className="text-foreground">Simulate</strong> → Sensitivity (if planned) → AI Assistant (optional) → Export.</p>
          <h3 className="font-display mt-6 text-base font-semibold text-foreground">2.8 Common first-session mistakes</h3>
...
ResourceB: 120
        ...
        <section>
          ...
          <p className="mt-3 text-[13px] leading-relaxed text-foreground/90"><strong className="text-foreground">Quick path:</strong> Example or Format Prompt → Draw Model → read the diagram (Ch.4) → Simulate → Sensitivity (if planned) → AI Assistant (optional) → Export.</p>
        </section>
