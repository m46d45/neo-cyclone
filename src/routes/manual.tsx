...
ResourceB: 120
        ...
        <section className="scroll-mt-24">
          ...
          <p className="mt-3 text-[14px] leading-[1.7] text-foreground/90">The footer can show how many times <strong className="text-foreground">Draw Model</strong> and <strong className="text-foreground">Simulate</strong> have been used. Counts are anonymous (no prompt text). A worldwide total needs a durable database; otherwise you still see counts for <em>this device</em>.</p>
